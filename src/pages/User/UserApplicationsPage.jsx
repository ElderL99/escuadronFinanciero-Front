      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-4">
          {apps.map((app) => (
            <div
              key={app._id}
              className="bg-white/90 border border-[#e8e2dc]/60 rounded-2xl shadow-sm hover:shadow-md 
              transition-colors transition-shadow will-change-transform"
            >
              <ApplicationCard
                app={app}
                isDetail={!!id}
        ...
        {id && (
          <div className="flex justify-center mt-10">
            <button
              ...
              className="bg-[#C5A572] text-[#611232] font-semibold px-6 py-3 rounded-full hover:bg-[#d4af37] transition-colors"
            >
